...
ScoreLabel = {}
ScoreLabel.maxDigits = 12
ScoreLabel.textFontSize = 60
...
function ScoreLabel.setNumber(self, number)
    local s = string.format('%0' .. ScoreLabel.maxDigits .. 'd', math.floor(number))
...
function ScoreLabel.create(self)
    local label = cc.Label:createWithTTF({
        fontFilePath = 'res/fonts/signika.ttf', fontSize = ScoreLabel.textFontSize,
